...
const TUTORIALS: Record<Lang, { player: { title: string; steps: { title: string; desc: string }[] }; admin: { title: string; steps: { title: string; desc: string }[] } }> = {
  ...
  th: {
    player: {
      ...
      steps: [
        { title: '1. เข้าร่วมกลุ่ม', desc: 'ขอ ID กลุ่มจากแอดมินแล้วใช้ !เข้าร่วม [id] เพื่อเข้าร่วมกลุ่มฟุตบอล' },
        ...
        { title: '5. ดูตารางอีเวนต์', desc: 'ใช้ !ตาราง เพื่อดูอีเวนต์ที่กำลังจะมาถึงทั้งหมดในกลุ่ม' },
    ...
    admin: {
      ...
      steps: [
        ...
        { title: '3. สร้างอีเวนต์', desc: 'ใช้ !สร้าง [วันที่] [เวลา] [นาที] [ทีม] [สูงสุด] ตัวอย่าง: !สร้าง 2024-04-20 19:00 90 8 2 14' },
        ...
        { title: '9. ตั้งค่าอีเวนต์ประจำ', desc: 'ใช้ !recurrente เพิ่ม [วัน] [เวลา] [นาที] [ทีม] [สูงสุด] ตัวอย่าง: !recurrente เพิ่ม พุธ 19:00 120 8 3 9' },
...
const PLAYER_CMDS: Record<Lang, Section[]> = {
  ...
  th: [
    ...
    },
    {
      title: 'อีเวนต์',
      cmds: [
        { cmd: '!ลงทะเบียน', desc: 'ลงทะเบียนเข้าร่วมอีเวนต์ที่เปิดอยู่', example: '!ลงทะเบียน' },
        { cmd: '!ยกเลิก', desc: 'ยกเลิกการลงทะเบียน', example: '!ยกเลิก' },
        { cmd: '!รายชื่อ', desc: 'ดูรายชื่อทีมที่แอดมินจัดแล้ว', example: '!รายชื่อ' },
        { cmd: '!ตาราง', desc: 'ดูรายการอีเวนต์ที่กำลังจะมาถึง', example: '!ตาราง' },
      ],
    },
    {
      title: 'โปรไฟล์และกลุ่ม',
      cmds: [
        { cmd: '!โปรไฟล์', desc: 'ดูตำแหน่งที่ชอบ ระดับ และสถิติ', example: '!โปรไฟล์' },
        ...
        { cmd: '!กลุ่ม', desc: 'ดูรายการกลุ่มที่คุณเข้าร่วม', example: '!กลุ่ม' },
        { cmd: '!เข้าร่วม [id]', desc: 'เข้าร่วมกลุ่มด้วย ID', example: '!เข้าร่วม abc12345' },
      ],
    },
  ],
};
  ...
  th: [
    {
      ...
      cmds: [
        { cmd: '!เริ่มต้น', desc: 'ลงทะเบียนกลุ่ม LINE ปัจจุบันและตั้งค่าตัวคุณเป็นแอดมิน', example: '!เริ่มต้น' },
      ],
    },
    {
      title: 'จัดการอีเวนต์',
      cmds: [
        { cmd: '!สร้าง [วันที่] [เวลา] [นาที] [ทีม] [สูงสุด]', desc: 'สร้างอีเวนต์ฟุตบอลใหม่', example: '!สร้าง 2024-04-20 19:00 90 8 2 14' },
        { cmd: '!จัดทีม', desc: 'สร้างรายชื่อทีมอัตโนมัติตามระดับผู้เล่น', example: '!จัดทีม' },
        { cmd: '!ปิด', desc: 'ปิดการลงทะเบียน ไม่รับสมัครเพิ่มอีก', example: '!ปิด' },
        { cmd: '!ลบ [id]', desc: 'ลบอีเวนต์ด้วย ID', example: '!ลบ abc12345' },
      ],
    },
    {
      title: 'ตั้งค่ากลุ่ม',
      cmds: [
        { cmd: '!ตั้งค่า [5|7|11]', desc: 'ตั้งค่าประเภทเกมเริ่มต้น', example: '!ตั้งค่า 7' },
    ...
    },
    {
      ...
      cmds: [
        { cmd: '!recurrente เพิ่ม [วัน] [เวลา] [นาที] [ทีม] [สูงสุด]', desc: 'สร้างอีเวนต์อัตโนมัติ 3 วันก่อน', example: '!recurrente เพิ่ม พุธ 19:00 120 8 3 9' },
    ...
    },
    {
      title: 'จัดการกลุ่ม',
      cmds: [
        { cmd: '!ลบกลุ่ม', desc: 'ลบกลุ่มและข้อมูลทั้งหมด (ใช้ด้วยความระมัดระวัง!)', example: '!ลบกลุ่ม' },
      ],
    },
  ],
};
